...
# = [[len(x) for x in item] for item in X]
train_X_len = [[min(max_sentence_length, len(x)) for x in item] for item in X]
...
valid_X_len = [[min(max_sentence_length, len(x)) for x in item] for item in X]
...
test_X_len = [[min(max_sentence_length, len(x)) for x in item] for item in X]
