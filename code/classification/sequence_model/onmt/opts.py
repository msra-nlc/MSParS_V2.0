...
def preprocess_opts(parser):
    ...
    group.add_argument('-src_seq_length', type=int, default=500,
                       help="Maximum source sequence length")
    group.add_argument('-src_seq_length_trunc', type=int, default=500,
                       help="Truncate source sequence length.")
    group.add_argument('-tgt_seq_length', type=int, default=100,
                       help="Maximum target sequence length to keep.")
    group.add_argument('-tgt_seq_length_trunc', type=int, default=100,
...
def train_opts(parser):
    ...
    group.add_argument('-save_checkpoint_steps', type=int, default=20000,
    ...
    group.add_argument('-max_generator_batches', type=int, default=32,
                       help="""Maximum batches of words in a sequence to run
                        ...
                        uses more memory.""")
    group.add_argument('-train_steps', type=int, default= 6000,
